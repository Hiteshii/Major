    ...
    void btnAddAction(ActionEvent event) {
        ...
        if(!flag){
            ...
            try {
                ...
                int a=Integer.parseInt(txtCustomerID.getText());

                ps.setString(3, "NONE");
                ps.setInt(4, a);
                ps.setString(5, LogInController.loggerUsername);
                ps.setString(6, txtPayMethod.getText());
                System.out.println(Integer.valueOf(lblId.getText())+" "+txtAccountID.getText()+" "+a+" "+LogInController.loggerUsername+" "+txtPayMethod.getText());
                ps.executeUpdate();
