...
public class AccountListController implements Initializable {
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        try {
            ...
            while (rs.next()) {
                System.out.println(rs.getInt(1)+" "+rs.getString(2)+" " +rs.getInt(4)+" " +rs.getString(5)+" "+ rs.getString(6));
                list.add(new Account(rs.getInt(1), rs.getString(2), rs.getInt(4), rs.getString(5), rs.getString(6)));
            }
