...
public class BaseController implements Initializable{
    ...
    void btnNavigators(ActionEvent event) {
        ...
        try {
            if(btnText.equals("Sells")) ctrlRightPane("/main/resources/view/Sells.fxml");
            else ctrlRightPane(FXML_URL.get(btnText));
        } catch (IOException e) {
            System.out.println(e);
            e.printStackTrace();
        }
    ...
    private void loadFXMLMap() {
        ...
        FXML_URL.put("Sales", "/main/resources/view/sells.fxml");
